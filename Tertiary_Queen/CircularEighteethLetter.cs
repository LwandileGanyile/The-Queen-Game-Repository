...
{
    public class CircularEighteethLetter : CircularLetter<CircularEighteethLetter, CircularEighteethDirection>, ILetterStateBase
    {
        ...
        public CircularEighteethLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
