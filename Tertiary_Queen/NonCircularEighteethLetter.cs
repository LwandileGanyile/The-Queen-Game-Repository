...
{
    public class NonCircularEighteethLetter : NonCircularLetter<NonCircularEighteethLetter, NonCircularEighteethDirection>, ILetterStateBase
    {
        ...
        public NonCircularEighteethLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
