...
{
    public class NonCircularEleventhLetter : NonCircularLetter<NonCircularEleventhLetter, NonCircularEleventhDirection>, ILetterStateBase, IPointIterator<R3Point>
    {
        public NonCircularEleventhLetter()
        {

        }

        public NonCircularEleventhLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override int CompareTo(NonCircularEleventhLetter other)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularEleventhLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularEleventhLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularEleventhLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularEleventhLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

       
        public override NonCircularEleventhLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }

        public override DirectionIterator<NonCircularEleventhDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularEleventhLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
