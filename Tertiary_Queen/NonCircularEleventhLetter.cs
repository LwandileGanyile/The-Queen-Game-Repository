...
{
    public class NonCircularEleventhLetter : NonCircularLetter<NonCircularEleventhLetter, NonCircularEleventhDirection>, ILetterStateBase
    {
        ...
        public NonCircularEleventhLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
