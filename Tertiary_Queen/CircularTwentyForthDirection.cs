...
namespace Tertiary_Queen
{
    public class CircularTwentyForthDirection : CircularDirection<CircularTwentyForthDirection,R3Point>, IDirectionStateBase
    {
        ...
        public CircularTwentyForthDirection(R3Point startingPoint, int direction, float directionLength, float directionDivisor, List<bool> canShootList)
        {

        }

        public override int CompareTo(CircularTwentyForthDirection comparableInstance)
        {
        ...
        public override CircularTwentyForthDirection ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularTwentyForthDirection translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }
    }
