...
{
    public class CircularFiftheenthLetter : CircularLetter<CircularFiftheenthLetter,CircularFiftheenthDirection>, ILetterStateBase
    {
        ...
        public CircularFiftheenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
