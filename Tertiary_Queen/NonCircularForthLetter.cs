...
namespace Tertiary_Queen
{
    public class NonCircularForthLetter : NonCircularLetter<NonCircularForthLetter, NonCircularForthDirection>, ILetterStateBase, IPointIterator<R3Point>
    {
        ...
        public override int CompareTo(NonCircularForthLetter other)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularForthLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularForthLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularForthLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularForthLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularForthLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
