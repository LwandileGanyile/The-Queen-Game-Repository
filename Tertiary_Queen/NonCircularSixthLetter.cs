...
{
    public class NonCircularSixthLetter : NonCircularLetter<NonCircularSixthLetter, NonCircularSixthDirection>, ILetterStateBase
    {
        ...
        public NonCircularSixthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
