...
{
    public class CircularEleventhLetter : CircularLetter<CircularEleventhLetter,R3Point>, ILetterStateBase
    {
        ...
        public CircularEleventhLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
