...
{
    public class NonCircularSeventhLetter : NonCircularLetter<NonCircularSeventhLetter, NonCircularSeventhDirection>, ILetterStateBase
    {
        ...
        public NonCircularSeventhLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
