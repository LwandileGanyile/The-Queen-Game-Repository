...
{
    public class CircularTwelventhLetter : CircularLetter<CircularTwelventhLetter,CircularTwelvethDirection>, ILetterStateBase, IPointIterator<R3Point>
    {

        public CircularTwelventhLetter()
        {
        ...
        public override int CompareTo(CircularTwelventhLetter comparableInstance)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularTwelventhLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override CircularTwelventhLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularTwelventhLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularTwelventhLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularTwelventhLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }

        public override DirectionIterator<CircularTwelvethDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularTwelventhLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
