...
{
    public class CircularSeventheenthLetter : CircularLetter<CircularSeventheenthLetter,CircularSeventheenthDirection>, ILetterStateBase
    {
        ...
        public CircularSeventheenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
