...
{
    public class NonCircularNinthLetter : NonCircularLetter<NonCircularNinthLetter, NonCircularNinthDirection>, ILetterStateBase, IPointIterator<R3Point>
    {
        ...
        public NonCircularNinthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override NonCircularNinthLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularNinthLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
