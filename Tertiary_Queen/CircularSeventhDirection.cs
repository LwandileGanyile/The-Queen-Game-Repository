...
{
    public class CircularSeventhDirection : CircularDirection<CircularSeventhDirection,R3Point>, IDirectionStateBase
    {
        public CircularSeventhDirection()
        {

        }

        public CircularSeventhDirection(R3Point startingPoint, int direction, float directionLength, float directionDivisor, List<bool> canShootList)
        {

        }

        public override int CompareTo(CircularSeventhDirection comparableInstance)
        {
        ...
        public override CircularSeventhDirection ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override CircularSeventhDirection ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularSeventhDirection ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularSeventhDirection RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularSeventhDirection RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularSeventhDirection translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }
    }
