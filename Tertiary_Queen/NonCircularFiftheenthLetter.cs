...
{
    public class NonCircularFiftheenthLetter : NonCircularLetter<NonCircularFiftheenthLetter, NonCircularFiftheenthDirection>, ILetterStateBase, IPointIterator<R3Point>
    {
        public NonCircularFiftheenthLetter()
        {

        }

        public NonCircularFiftheenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override int CompareTo(NonCircularFiftheenthLetter other)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularFiftheenthLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularFiftheenthLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularFiftheenthLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularFiftheenthLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularFiftheenthLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularFiftheenthLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
