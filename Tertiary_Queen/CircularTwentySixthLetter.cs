...
{
    public class CircularTwentySixthLetter : CircularLetter<CircularTwentySixthLetter,CircularTwentySixthDirection>, ILetterStateBase,IPointIterator<R3Point>
    {

        public CircularTwentySixthLetter()
        {
        ...
        public override int CompareTo(CircularTwentySixthLetter comparableInstance)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularTwentySixthLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override CircularTwentySixthLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularTwentySixthLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularTwentySixthLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularTwentySixthLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }

        public override DirectionIterator<CircularTwentySixthDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularTwentySixthLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
