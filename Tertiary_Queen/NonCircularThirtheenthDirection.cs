...
{
    public class NonCircularThirtheenthDirection : NonCircularDirection<NonCircularThirtheenthDirection,R3Point>, IDirectionStateBase
    {

        public NonCircularThirtheenthDirection()
        {

        }

        public NonCircularThirtheenthDirection(R3Point startingPoint, int direction, float directionLength, float directionDivisor, List<bool> canShootList)
        {

        }

        public override int CompareTo(NonCircularThirtheenthDirection comparableInstance)
        {
        ...
        public override NonCircularThirtheenthDirection ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularThirtheenthDirection ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularThirtheenthDirection ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularThirtheenthDirection RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularThirtheenthDirection RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularThirtheenthDirection translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }
    }
