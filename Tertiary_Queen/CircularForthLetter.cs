...
{
    public class CircularForthLetter : CircularLetter<CircularForthLetter,CircularForthDirection>, ILetterStateBase
    {
        ...
        public CircularForthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
