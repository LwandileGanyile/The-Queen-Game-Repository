...
{
    public class CircularTwentyeenthLetter : CircularLetter<CircularTwentyeenthLetter,CircularTwentyeethDirection>, ILetterStateBase
    {
        ...
        public CircularTwentyeenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
