...
{
    public class NonCircularSeventheenthDirection : NonCircularDirection<NonCircularSeventheenthDirection,R3Point>, IDirectionStateBase
    {

        public NonCircularSeventheenthDirection()
        {

        }

        public NonCircularSeventheenthDirection(R3Point startingPoint, int direction, float directionLength, float directionDivisor, List<bool> canShootList)
        {

        }

        public override int CompareTo(NonCircularSeventheenthDirection comparableInstance)
        {
        ...
        public override NonCircularSeventheenthDirection ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSeventheenthDirection ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSeventheenthDirection ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularSeventheenthDirection RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSeventheenthDirection RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSeventheenthDirection translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }
    }
