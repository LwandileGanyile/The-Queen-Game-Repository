...
{
    public class R3Letter :ILetterStateBase
    {

        private ILetterStateBase letterState;
        ...
        public R3Letter(ILetterStateBase letterState)
        {
        ...
        public void changeLetterPerspective(ILetterStateBase letterState)
        {
