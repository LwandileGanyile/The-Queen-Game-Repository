...
{
    public class NonCircularTenthLetter : NonCircularLetter<NonCircularTenthLetter, NonCircularTenthDirection>, ILetterStateBase
    {
        ...
        public NonCircularTenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
