...
{
    public class NonCircularTenthLetter : NonCircularLetter<NonCircularTenthLetter, NonCircularTenthDirection>, ILetterStateBase, IPointIterator<R3Point>
    {
        public NonCircularTenthLetter()
        {

        }

        public NonCircularTenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override int CompareTo(NonCircularTenthLetter other)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularTenthLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTenthLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTenthLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTenthLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override DirectionIterator<NonCircularTenthDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }

        public override LetterIterator<NonCircularTenthLetter> RetrieveLetterIterator()
        {
            throw new NotImplementedException();
        }
