...
{
    public class NonCircularThirtheenthLetter : NonCircularLetter<NonCircularThirtheenthLetter, NonCircularThirtheenthDirection>, ILetterStateBase
    {
        ...
        public NonCircularThirtheenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
