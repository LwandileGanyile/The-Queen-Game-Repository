...
{
    public class NonCircularSeventheenthLetter : NonCircularLetter<NonCircularSeventheenthLetter, NonCircularSeventheenthDirection>, ILetterStateBase
    {
        ...
        public NonCircularSeventheenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
