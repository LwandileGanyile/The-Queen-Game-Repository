...
{
    public class NonCircularSeventheenthLetter : NonCircularLetter<NonCircularSeventheenthLetter, NonCircularSeventheenthDirection>, ILetterStateBase, IPointIterator<R3Point>
    {
        public NonCircularSeventheenthLetter()
        {

        }

        public NonCircularSeventheenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override int CompareTo(NonCircularSeventheenthLetter other)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularSeventheenthLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSeventheenthLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSeventheenthLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSeventheenthLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularSeventheenthLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }

        public override DirectionIterator<NonCircularSeventheenthDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularSeventheenthLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
