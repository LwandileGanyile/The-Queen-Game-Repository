...
{
    public class NonCircularTwentySecondLetter : NonCircularLetter<NonCircularTwentySecondLetter, NonCircularTwentySecondDirection>, ILetterStateBase
    {
        ...
        public NonCircularTwentySecondLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
