...
{
    public class CircularTenthLetter : CircularLetter<CircularTenthLetter,CircularTenthDirection>, ILetterStateBase
    {

        public CircularTenthLetter()
        {
        ...
        public override int CompareTo(CircularTenthLetter comparableInstance)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularTenthLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override CircularTenthLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularTenthLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularTenthLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularTenthLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
