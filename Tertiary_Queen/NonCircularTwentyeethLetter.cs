...
{
    public class NonCircularTwentyeethLetter : NonCircularLetter<NonCircularTwentyeethLetter, NonCircularTwentyeethDirection>, ILetterStateBase, IPointIterator<R3Point>
    {
        public NonCircularTwentyeethLetter()
        {

        }

        public NonCircularTwentyeethLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override int CompareTo(NonCircularTwentyeethLetter other)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularTwentyeethLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentyeethLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentyeethLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentyeethLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularTwentyeethLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }

        public override DirectionIterator<NonCircularTwentyeethDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularTwentyeethLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
