...
{
    public class CircularFifthLetter : CircularLetter<CircularFifthLetter,CircularFifthDirection>, ILetterStateBase, IPointIterator<R3Point>
    {

        public CircularFifthLetter()
        {

        }

        public CircularFifthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override int CompareTo(CircularFifthLetter comparableInstance)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularFifthLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override CircularFifthLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularFifthLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularFifthLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

       
        public override CircularFifthLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }

        public override DirectionIterator<CircularFifthDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularFifthLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
