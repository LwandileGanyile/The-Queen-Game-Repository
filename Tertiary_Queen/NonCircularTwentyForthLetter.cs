...
{
    public class NonCircularTwentyForthLetter : NonCircularLetter<NonCircularTwentyForthLetter, NonCircularTwentyForthDirection>, ILetterStateBase
    {
        ...
        public NonCircularTwentyForthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
