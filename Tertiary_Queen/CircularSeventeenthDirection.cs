...
namespace Tertiary_Queen
{
    public class CircularSeventheenthDirection : CircularDirection<CircularSeventheenthDirection,R3Direction>, IDirectionStateBase, IPointIterator<R3Point>
    {
        ...
        public override int CompareTo(CircularSeventheenthDirection comparableInstance)
        {
        ...
        public override CircularSeventheenthDirection ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override CircularSeventheenthDirection ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularSeventheenthDirection ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularSeventheenthDirection RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
