...
{
    public class NonCircularTwentyFirstLetter : NonCircularLetter<NonCircularTwentyFirstLetter, NonCircularTwentyFirstDirection>, ILetterStateBase, IPointIterator<R3Point>
    {
        public NonCircularTwentyFirstLetter()
        {

        }

        public NonCircularTwentyFirstLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override int CompareTo(NonCircularTwentyFirstLetter other)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularTwentyFirstLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentyFirstLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentyFirstLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentyFirstLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularTwentyFirstLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }

        public override DirectionIterator<NonCircularTwentyFirstDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularTwentyFirstLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
