...
{
    public class NonCircularTwentyFifthLetter : NonCircularLetter<NonCircularTwentyFifthLetter, NonCircularTwentyFifthDirection>, ILetterStateBase, IPointIterator<R3Point>
    {
        public NonCircularTwentyFifthLetter()
        {

        }

        public NonCircularTwentyFifthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override int CompareTo(NonCircularTwentyFifthLetter other)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularTwentyFifthLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentyFifthLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentyFifthLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentyFifthLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        
        public override NonCircularTwentyFifthLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }

        public override DirectionIterator<NonCircularTwentyFifthDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularTwentyFifthLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
