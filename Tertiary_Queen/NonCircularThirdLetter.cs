...
{
    public class NonCircularThirdLetter : NonCircularLetter<NonCircularThirdLetter, NonCircularThirdDirection>, ILetterStateBase
    {
        public NonCircularThirdLetter()
        {
        ...
        public override int CompareTo(NonCircularThirdLetter other)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularThirdLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularThirdLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularThirdLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularThirdLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularThirdLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
