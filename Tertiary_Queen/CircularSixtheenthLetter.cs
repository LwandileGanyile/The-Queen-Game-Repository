...
{
    public class CircularSixtheenthLetter : CircularLetter<CircularSixtheenthLetter,CircularSixtheenthDirection>, ILetterStateBase
    {
        ...
        public CircularSixtheenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
