...
{
    public class NonCircularTwentySixthDirection : NonCircularDirection<NonCircularTwentySixthDirection,R3Point>, IDirectionStateBase
    {

        public NonCircularTwentySixthDirection()
        {

        }

        public NonCircularTwentySixthDirection(R3Point startingPoint, int direction, float directionLength, float directionDivisor, List<bool> canShootList)
        {

        }

        public override int CompareTo(NonCircularTwentySixthDirection comparableInstance)
        {
        ...
        public override NonCircularTwentySixthDirection ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentySixthDirection ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentySixthDirection ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularTwentySixthDirection RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentySixthDirection RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularTwentySixthDirection translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }
    }
