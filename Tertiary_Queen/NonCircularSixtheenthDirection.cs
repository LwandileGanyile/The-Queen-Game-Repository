...
{
    public class NonCircularSixtheenthDirection : NonCircularDirection<NonCircularSixtheenthDirection,R3Point>, IDirectionStateBase
    {

        public NonCircularSixtheenthDirection()
        {

        }

        public NonCircularSixtheenthDirection(R3Point startingPoint, int direction, float directionLength, float directionDivisor, List<bool> canShootList)
        {

        }

        public override int CompareTo(NonCircularSixtheenthDirection comparableInstance)
        {
        ...
        public override NonCircularSixtheenthDirection ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSixtheenthDirection ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSixtheenthDirection ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularSixtheenthDirection RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSixtheenthDirection RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularSixtheenthDirection translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }
    }
