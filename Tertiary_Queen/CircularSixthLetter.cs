...
{
    public class CircularSixthLetter : CircularLetter<CircularSixthLetter,CircularSixthDirection>, ILetterStateBase
    {
        ...
        public CircularSixthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
