...
{
    public class CircularThirdLetter : CircularLetter<CircularThirdLetter,CircularThirdDirection>, ILetterStateBase
    {
        ...
        public CircularThirdLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, int letterDuration)
        {
