...
{
    public class NonCircularEighteethDirection : NonCircularDirection<NonCircularEighteethDirection,R3Point>, IDirectionStateBase
    {

        public NonCircularEighteethDirection()
        {

        }

        public NonCircularEighteethDirection(R3Point startingPoint, int direction, float directionLength, float directionDivisor, List<bool> canShootList)
        {

        }

        public override int CompareTo(NonCircularEighteethDirection comparableInstance)
        {
        ...
        public override NonCircularEighteethDirection ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override NonCircularEighteethDirection ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularEighteethDirection ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override NonCircularEighteethDirection RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularEighteethDirection RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override NonCircularEighteethDirection translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }
    }
