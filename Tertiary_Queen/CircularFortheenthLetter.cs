...
{
    public class CircularFortheenthLetter : CircularLetter<CircularFortheenthLetter,CircularFortheenthDirection>, ILetterStateBase, IPointIterator<R3Point>
    {

        public CircularFortheenthLetter()
        {

        }

        public CircularFortheenthLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override int CompareTo(CircularFortheenthLetter comparableInstance)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularFortheenthLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override CircularFortheenthLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularFortheenthLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularFortheenthLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularFortheenthLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }

        public override DirectionIterator<CircularFortheenthDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularFortheenthLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
