...
{
    public class CircularTwentyThirdLetter : CircularLetter<CircularTwentyThirdLetter,CircularTwentyThirdDirection>, ILetterStateBase, IPointIterator<R3Point>
    {

        public CircularTwentyThirdLetter()
        {

        }

        public CircularTwentyThirdLetter(R3Point startingPoint, char letter, int letterDirection, R3Plane onPlane, bool smaller, Dictionary<int,int> duration)
        {
        ...
        public override int CompareTo(CircularTwentyThirdLetter comparableInstance)
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularTwentyThirdLetter ReflectAboutAxis(int axisIndex)
        {
            throw new NotImplementedException();
        }

        public override CircularTwentyThirdLetter ReflectAroundEqualAxis(List<int> axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularTwentyThirdLetter RotateAroundAxis(int indexOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }

        public override CircularTwentyThirdLetter RotateAroundEqualAxis(List<int> indecesOfAxis, int numberOfTimes)
        {
            throw new NotImplementedException();
        }


        public override CircularTwentyThirdLetter translate(int coordinateSystemDirection, float amaunt)
        {
            throw new NotImplementedException();
        }

        public override DirectionIterator<CircularTwentyThirdDirection> RetrieveDirectionIterator()
        {
            throw new NotImplementedException();
        }
        ...
        public override CircularTwentyThirdLetter ReflectAboutEqualAxis(int[] axisIndeces, int numberOfTimes)
        {
            throw new NotImplementedException();
        }
    }
